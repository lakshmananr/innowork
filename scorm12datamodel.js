...
function SCORMapi1_2() {
    ...
    function LMSSetValue (element,value) {
        ...
        if(element == 'cmi.core.session_time')
        {
            ...
            http(history.page, history.time);
        }
    ...
    function LMSCommit (param) {
        ...
        if (param == "") {
            if (Initialized) {
                ...
                // var time = dateToMins();
                // var params = JSON.stringify({userData: {user_id : 1504}, activity_id: params[8],
                //                 text: text,plan_id:params[9], time: time});
...
function http(page, time) {
    ...
    var URL =  'http://localhost/tc_v3.0/api/internaltraining/updateLearningHistory';
    time = '00:00:00';
    ...
    var text = 'Viewed Page '+ page;

    xhttp.open("POST", URL, true);
    xhttp.send("userData="+JSON.stringify({user_id:1504})+"&activity_id="+params[8]+"&text="+text+"&plan_id="+params[9]+"&time="+time);
}